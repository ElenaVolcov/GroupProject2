...
public interface Task5 {
  /*
    ...
    2. Create TakesScreenshot Interface:
        void getScreenshot()
    3. Create RemoteWebDriver Interface that inherits from
    WebDriver and TakesScreenshot:
        void navigate()
    4. Create 3 classes ChromeDriver, FirefoxDriver, SafariDriver that
    implements functionality defined in the RemoteWebDriver Interface
     */
}
